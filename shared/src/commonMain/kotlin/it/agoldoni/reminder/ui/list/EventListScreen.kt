...
fun EventListScreen(
    ...
    if (showInfoDialog) {
        AlertDialog(
            ...
            title = { Text("Info") },
            text = {
                val info = LocalAppContainer.current.appInfo
                Column {
                    Text("Autore: ${info.author}")
                    Spacer(Modifier.height(4.dp))
                    Text("Versione: ${info.version} (build ${info.build})")
                    Spacer(Modifier.height(4.dp))
                    Text("Build: ${info.buildDate}")
                }
            },
            confirmButton = {
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Spacer(Modifier.height(4.dp))
                Text(
                    text = formatDateTime(event.dateTimeMillis),
                ...
                Spacer(Modifier.height(4.dp))
                Text(
                    text = "Notifica: ${formatDateTime(notificationMillis)}",
